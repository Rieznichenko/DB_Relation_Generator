...
def parse_cli():
    ...
    parser.add_argument('--mongo-db', default='threatfeeds', help='MongoDB database.')
    parser.add_argument('--mongo-dummy-collection', default='feeds', help='MongoDB collection.')
